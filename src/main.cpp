...
int main()
{
    ...
    glGenVertexArrays(1, &VAO1);//顶点数组
    glGenBuffers(1, &VBO1); //顶点缓冲
    glGenBuffers(1, &EBO);

    glBindVertexArray(VAO1);
    glBindBuffer(GL_ARRAY_BUFFER, VBO1); //把顶点数组复制到缓冲中
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        unsigned int transform = glGetUniformLocation(firstShader.ID, "transform");
